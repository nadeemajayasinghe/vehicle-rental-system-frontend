            ...
            <div style={{
                ...
                <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.05rem' }}>
                        Secure payment processing for vehicle rentals.
                    </p>
                </div>
            </div>
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px 80px' }}>
                <div style={{
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: 1.7, maxWidth: '480px', margin: '0 auto 12px' }}>
                        The payment module will support secure online transactions, split payments, invoice generation, and multiple payment methods including credit cards and digital wallets.
                    </p>
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '36px' }}>
                        This section will be fully integrated once the payment microservice is deployed.
                    </p>
